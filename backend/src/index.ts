...
// GET setup — создаёт таблицы и admin пользователя (удалить после использования)
app.get('/api/setup', async (_req, res) => {
  try {
    const email = 'basegipoteza@gmail.com';
    const password = 'Lets#-bro-Pass#323255';
    ...
    return res.json({ message: 'Admin created! You can now login.', email });
  } catch (err: any) {
